...
<style>
  ...
  /* Chrome Overrides for Clean Landing View */
  ...
  .brand-icon {
      ...
      box-shadow: 0 0 18px rgba(88, 193, 200, 0.35);
      display: flex;
      align-items: center;
  ...
  .btn-primary {
      background: rgb(88, 193, 200);
      color: #050505;
      box-shadow: 0 0 20px rgba(88, 193, 200, 0.35);
  }
  ...
  .status-dot {
      ...
      border-radius: 50%;
      background: rgb(88, 193, 200);
      box-shadow: 0 0 8px rgb(88, 193, 200);
  ...
  .dash-input-container:focus-within {
      border-color: rgb(88, 193, 200);
      box-shadow: 0 0 25px rgba(88, 193, 200, 0.35);
  }
  ...
  .quad-item:hover {
      border-color: rgba(88, 193, 200, 0.3);
  ...
  .radial-score {
      ...
      height: 3.5rem;
      border-radius: 50%;
      border: 3px solid rgb(88, 193, 200);
      ...
      color: rgb(88, 193, 200);
      font-size: 1rem;
      box-shadow: 0 0 15px rgba(88, 193, 200, 0.35);
  }
  ...
  .founder-img {
      ...
      border-radius: 50%;
      object-fit: cover;
      border: 2px solid rgb(88, 193, 200);
  }
...
<div class="topper-landing-wrapper">
  ...
  <div class="landing-content">
    ...
    <header class="navbar">
      <div class="container nav-wrapper">
        <a href="?page=home" target="_self" class="brand">
        ...
        <div class="nav-actions">
          <a href="?page=login" target="_self" class="btn btn-secondary">Login</a>
          <a href="?page=login" target="_self" class="btn btn-primary">Explore Tools →</a>
        </div>
      </div>
    </header>

    <!-- Hero Grid: Left Content + Right Mockup -->
      ...
      <div class="hero-grid">
        ...
        <div class="hero-left">
          ...
          <div class="hero-actions">
            <a href="?page=login" target="_self" class="btn btn-primary">
              Start Learning Free →
            </a>
        ...
        <!-- RIGHT COLUMN: SIMULATED WORKSPACE MOCKUP -->
        <div class="dashboard-wrapper">
          <div class="dashboard-card">
            ...
            <!-- Live Search Form -->
            <form class="dash-search-form" action="/" method="GET" target="_self">
              <input type="hidden" name="page" value="login" />
              <div class="dash-input-container">
                <span style="color: rgb(88, 193, 200); margin-right: 0.5rem; font-family: 'Space Mono', monospace;">✧</span>
                <input
                  type="text"
                  name="query"
                  class="dash-input"
            ...
            <div class="quick-chips">
              <a href="?page=login&query=Explain+the+mechanism+of+Photosynthesis+and+cellular+energy+balance" target="_self" class="chip-btn">💡 Explain</a>
              <a href="?page=login&query=Summarize+key+laws+of+Thermodynamics+in+high-yield+bullet+points" target="_self" class="chip-btn">📄 Summarize</a>
              <a href="?page=login&query=Give+me+3+practice+problems+on+Calculus+Integration+with+step-by-step+solutions" target="_self" class="chip-btn">🎯 Practice</a>
              <a href="?page=login&query=Generate+a+15-minute+quick+study+roadmap+for+Quantum+Physics+basics" target="_self" class="chip-btn">📖 Study</a>
            </div>

            <!-- 4-Tool Quad Grid -->
            <div class="tool-quad-grid">
              <a href="?page=login&query=Study+GPT" target="_self" class="quad-item">
                <div>
              ...
              <a href="?page=login&query=Short+Notes" target="_self" class="quad-item">
                <div>
                  <div class="quad-icon">📄</div>
              ...
              <a href="?page=login&query=Practice+Exam+Questions" target="_self" class="quad-item">
                <div>
                  <div class="quad-icon">🎯</div>
              ...
              <a href="?page=login" target="_self" class="quad-item">
                <div>
                  <div class="quad-icon">📈</div>
          ...
          <div class="floating-badge-progress">
            <span style="font-size: 0.75rem; font-family: 'Space Mono', monospace; color: #888888; font-weight: 700;">Your Progress</span>
            <div class="radial-score">78%</div>
            <p style="font-size: 0.7rem; font-family: 'Space Mono', monospace; color: #888888; margin: 0;">
              Topics <strong style="color: rgb(88, 193, 200);">24 / 31</strong>
            </p>
          </div>

          <div class="floating-badge-tutor">
            <div style="width: 2.75rem; height: 2.75rem; border-radius: 0.75rem; background: rgba(88, 193, 200, 0.15); border: 1px solid rgba(88, 193, 200, 0.3); display: flex; align-items: center; justify-content: center; font-size: 1.35rem;">
              🧠
            </div>
            <div>
              <span style="font-size: 0.65rem; color: #555555; text-transform: uppercase; font-family: 'Space Mono', monospace; font-weight: 700; display: block;">AI Study Tutor</span>
              <strong style="font-size: 0.8rem; color: #fff;">Always Ready</strong>
              <p style="font-size: 0.65rem; color: rgb(88, 193, 200); margin: 0;">24/7 Smart Guidance</p>
            </div>
          </div>
          ...
          <div class="floating-badge-trophy">
            ...
            <div>
              <div style="font-size: 0.75rem; font-weight: 700; color: rgb(88, 193, 200); font-family: 'Space Mono', monospace;">Higher Scores</div>
              <div style="font-size: 0.65rem; color: #888888;">Brighter Future →</div>
            </div>
          </div>
    ...
    <section class="hero-center" id="research">
      <div class="container">
        ...
        <form action="/" method="GET" target="_self" class="search-box">
          <input type="hidden" name="page" value="login" />
    ...
    <section id="tools" class="container">
      <div class="section-header">
        ...
        <h2 class="section-title">Supercharge Your <span style="color: rgb(88, 193, 200);">Study Routine</span></h2>
      </div>

      <div class="tools-grid">
        <!-- Card 1 -->
        <a href="?page=login&feature=tutor" target="_self" class="tool-card">
        ...
        <!-- Card 2 -->
        <a href="?page=login&feature=notes" target="_self" class="tool-card">
        ...
        <!-- Card 3 -->
        <a href="?page=login&feature=predict" target="_self" class="tool-card">
        ...
        <!-- Card 4 -->
        <a href="?page=login&feature=solver" target="_self" class="tool-card">
          <div>
            <div class="tool-card-icon">⚡</div>
        ...
        <!-- Card 5 -->
        <a href="?page=login&feature=flashcards" target="_self" class="tool-card">
          <div>
        ...
        <!-- Card 6 -->
        <a href="?page=login&feature=analytics" target="_self" class="tool-card">
          <div>
            <div class="tool-card-icon">📊</div>
    ...
    <section class="founder-section" id="business">
      <div class="container">
        ...
        <h2 class="founder-title">
          The mind behind <span>Topper</span><span style="color: rgb(88, 193, 200);">GPT</span>
        </h2>
